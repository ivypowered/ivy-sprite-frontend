            ...
            <div className="border-2 border-red-500 bg-slate-900">
                ...
                <div className="p-6">
                    <p className="text-slate-300">
                        This link is invalid or has expired. Please generate a
                        new link using the{" "}
            ...
            <div className="p-6 space-y-6">
                ...
                <div>
                    <label className="text-xs uppercase text-slate-500 tracking-wider flex items-center gap-1">
                        <span className="text-sky-400">▸</span> {platform} User
                        ID
                    </label>
                ...
                <div>
                    <label className="text-xs uppercase text-slate-500 tracking-wider flex items-center gap-1">
                        <span className="text-sky-400">▸</span> Wallet to Link
                    </label>
                ...
                {publicKey && (
                    <div>
                        <label className="text-xs uppercase text-slate-500 tracking-wider flex items-center gap-1">
                            <span className="text-sky-400">▸</span> Connected
                            Wallet
                        </label>
                        <div
